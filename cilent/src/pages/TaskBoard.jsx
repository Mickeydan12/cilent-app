...
import inProgressIcon from "../assets/time.svg";
import completedIcon from "../assets/timer.svg";
import plannedIcon from "../assets/document-text.svg";
import allProjectIcon from "../assets/briefcase (1).svg";
import Table from "react-bootstrap/Table";
import { table } from "../Table/taskboard";
import { Link } from "react-router-dom";
import addIcon from "../assets/addIcon.svg.svg";
      ...
      {match ? (
        <main className="mt-lg-5 container">
          <div className="d-flex align-items-center justify-content-between">
            ...
            <Link to="/admin-dashboard/newtask">
              <button
                style={{
                  width: "100%",
                  color: "white",
          ...
          <div className="mt-4 gap-3 d-lg-flex d-md-block  ">
